    ...
    <transition
      ...
      <div v-show="menu" class="absolute z-50" :class="class" @click="menu = false">
        <div class="shadow-lg w-full bg-dark-6 text-white">
          ...
          <div class="p-2">
            <Link class="flex items-center  p-2 hover:bg-dark-3 rounded-md" :href="route('admin.profile.show')">
            ...
            <Link class="flex items-center  p-2 hover:bg-dark-3 rounded-md" :href="route('admin.profile.password')">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 h-4 mr-2" viewBox="0 0 16 16">
          ...
          <div class="p-2 border-t border-dark-3">
            <Link class="flex items-center  p-2 hover:bg-dark-3 rounded-md" :href="route('logout')">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 h-4 mr-2" viewBox="0 0 16 16">
